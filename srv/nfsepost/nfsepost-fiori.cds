using NfsePost as service from './nfsepost-service';

///////////////////////////////////////////////////////////////////////////
//	Nota Fiscal Post Parameters List Page
////////////////////////////////////////////////////////////////////////////
annotate NfsePost.NotasFiscaisPostParameters with @(
	UI: {
...
////////////////////////////////////////////////////////////////////////////
//	Nota Fiscal Post Parameters Object Page
////////////////////////////////////////////////////////////////////////////
	UI: {
        HeaderInfo: {
            Title : { 
                $Type : 'UI.DataField',
                Value: '{i18n>nfsepostparameters_plural}',
                ![@UI.Hidden],
            },
            TypeName: '{i18n>nfsepostparameters_singular}',
            TypeNamePlural: '{i18n>nfsepostparameters_plural}', 
        },
...
////////////////////////////////////////////////////////////////////////////
annotate NfsePost.NotasFiscaisPostLog with @(
UI: {
        TextArrangement: #TextOnly,
		LineItem: [
            {   
...
////////////////////////////////////////////////////////////////////////////
	UI: {
        HeaderInfo: {
            ...
            TypeName: '{i18n>nfsepostlog_singular}',
            TypeNamePlural: '{i18n>nfsepostlog_plural}', 
        },
        HeaderFacets            : [
            {
                $Type  : 'UI.ReferenceFacet',
...
////////////////////////////////////////////////////////////////////////////
annotate NfsePost.NotasFiscais with @(
	UI: {
        TextArrangement: #TextOnly,
		LineItem: [
			{   
...
////////////////////////////////////////////////////////////////////////////
annotate  NfsePost.NotasFiscaisLog with @(
    UI: {
        TextArrangement: #TextOnly,
		LineItem: [
			{   
